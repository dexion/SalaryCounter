...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public void initialize(OnTimeSetListener callback,
        ...
        mInitialMinute = minuteOfHour;
        mInitialHourOfDayEnd = hourOfDayEnd;
        mInitialMinuteEnd = minuteOfHourEnd;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        startDatePage.setIndicator(getString(R.string.daterange_picker_from));

        TabHost.TabSpec endDatePage = tabHost.newTabSpec("end");
        endDatePage.setContent(R.id.end_date_group);
        endDatePage.setIndicator(getString(R.string.daterange_picker_to));
