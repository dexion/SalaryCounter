...
public class RadialPickerLayout extends FrameLayout implements OnTouchListener {
    ...
    private static final int HOUR_INDEX = TimeRangePickerDialog.HOUR_INDEX;
    private static final int MINUTE_INDEX = TimeRangePickerDialog.MINUTE_INDEX;
    private static final int AMPM_INDEX = TimeRangePickerDialog.AMPM_INDEX;
    private static final int ENABLE_PICKER_INDEX = TimeRangePickerDialog.ENABLE_PICKER_INDEX;
    private static final int AM = TimeRangePickerDialog.AM;
    private static final int PM = TimeRangePickerDialog.PM;

    private int mLastValueSelected;

    private TimeRangePickerDialog mTimePickerDialog;
    ...
    **/
     ...
     * @param is24HourMode
     */
    public void initialize(Context context, TimeRangePickerDialog timePickerDialog,
